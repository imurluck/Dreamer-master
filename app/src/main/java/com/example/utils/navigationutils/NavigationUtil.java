package com.example.utils.navigationutils;
...
import com.example.dreamera_master.BNDemoGuideActivity;
...
public class NavigationUtil {
    ...
    private String TAG = "NavihationUtil";

    public static List<Activity> activityList = new LinkedList<Activity>();

    private static final String APP_FOLDER_NAME = "GREAMER_MASTER";
    ...
    public void initNavi() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 23) {
            ...
            if (!hasBasePhoneAuth()) {
                Toast.makeText(activity, "权限不够， 无法使用导航功能", Toast.LENGTH_SHORT).show();
        ...
        BaiduNaviManager.getInstance().init(activity, mSDCardPath, APP_FOLDER_NAME, new NaviInitListener() {
            @Override
    ...
    public void routeplanToNavi(double startLongitude, double startLatitude,
                                double endLongitude, double endLatitude) {
        Log.e(TAG, "routeplanToNavi excute");
        mCoordinateType = CoordinateType.BD09LL;
        if (!hasInitSuccess) {
        ...
        sNode = new BNRoutePlanNode(startLongitude,
                startLatitude, "百度大厦", null,
                CoordinateType.BD09LL);
        eNode = new BNRoutePlanNode(endLongitude,
                endLatitude, "北京天安门", null,
                CoordinateType.BD09LL);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        // TODO Auto-generated method stub
        Log.e(TAG, "onRequestPermissionResule");
        //activity.onRequestPermissionsResult(requestCode, permissions, grantResults);
        Log.e(TAG, TAG + "MainActivity onRequestPermissionResult");
        if (requestCode == authBaseRequestCode) {
            for (int ret : grantResults) {
                if (ret == 0) {
                    continue;
                } else {
                    Toast.makeText(activity, "缺少导航基本的权限!", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            initNavi();
            ...
            routeplanToNavi(startLongitude, startLatitude,
